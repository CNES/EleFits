...
constexpr Linx::Index RandomHeader::record_count;
...
RandomHeader::RandomHeader() :
    ...
    ui {generate_random_record<unsigned int>("unsigned int")},
    ul {generate_random_record<unsigned short>("unsigned long")},
